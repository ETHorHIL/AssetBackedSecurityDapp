...
/*
TO DO:
!!! make sure trx doesnt kick off before - investors can check all is fine
Think about what to do with excess funds
build a function to enable the originator to call the transaction
think about what happens in emergency Classes
handle the end of the trax (final maturity)
build a callback function for all trx
*/
